...
curr_range = '60nA'     # Name of current range for test [-10uA, +10uA]
...
test_param = { 
        ...
        'value'      : 0.005,        # Output volatage (V) durring constant voltage test
        'duration'   : 40000,       # Duration of constant voltage test (ms)
        }
